...
const CardSkeleton = () => {
  return (
    <div className="w-full flex flex-col max-w-[280px] mb-14 bg-white dark:bg-bg-dark-blue rounded-[5px]">
      <div className="flex animate-pulse flex-row items-center h-40 justify-center space-x-5">
        <div className="bg-gray-300 dark:bg-dark-blue h-full w-full "></div>
      </div>
